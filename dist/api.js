...
export class APIManager {
     ...
     */
    convertToCRApplicationData(crApplication) {
        ...
        // 转换组件模块为API格式
        const componentList = componentModules.map((module) => ({
        ...
        // 转换功能模块为API格式
        const functionList = functionModules.map((module) => ({
     ...
     * 获取CR申请单列表
     */
    async getCRApplicationList(params = {}) {
     ...
     * 修改CR申请单状态
     */
    async checkCRApplicationStatus(params) {
